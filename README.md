...
* 3.0.5: Updated standalone UI mode for 9.0. Fix reactive station subordinates not undocking from other ships or stations.
* 3.0.4: Updated standalone UI mode for 8.0
